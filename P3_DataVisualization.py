...
plt.scatter(top100.bpm, top100.valence, color='green', label='100 canciones mas bailables')
plt.scatter(bot100.bpm, bot100.valence, color='red', label='100 canciones menos bailables')
plt.legend()
